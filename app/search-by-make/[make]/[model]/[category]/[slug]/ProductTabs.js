                ...
                {activeTab === 'policies' && (
                    <div>
                        ...
                        <ul className={`list-disc pl-5 space-y-1 text-gray-700 ${firaSans.className}`}>
                            ...
                            <li><strong>Delivery:</strong> {`Estimated between ${new Date().toLocaleDateString("en-US", { month: "short", day: "numeric" })} - ${new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toLocaleDateString("en-US", { month: "short", day: "numeric" })}`}</li>
